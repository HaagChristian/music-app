...
from src.database.music_db.db_models import Song, Artist, Album, Genre
from src.database.music_db.db_search import fetch_all_search_criteria
...
@patch('src.database.music_db.db_search.Song')
...
@patch('src.database.music_db.db_search.Artist')
...
@patch('src.database.music_db.db_search.Genre')
...
@patch('src.database.music_db.db_search.Album')
